...
// Run puts stdin into raw mode and waits for a key or switchSignal — both
// space and a closed switchSignal return SwitchToUI; q/Q/Ctrl-C return
// Quit. Pass nil for switchSignal to only react to keypresses.
//
